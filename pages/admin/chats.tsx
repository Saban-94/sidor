              ...
              <div className="space-y-6">
                  ...
                  <div className="p-4 bg-slate-900 rounded-2xl border border-white/5 space-y-4 shadow-xl">
                      <div className="space-y-1">
                          ...
                          <input value={sysConfig.rtDbUrl} onChange={e => setSysConfig({...sysConfig, rtDbUrl: e.target.value})} className="w-full bg-black/40 p-3 rounded-lg text-[11px] font-mono outline-none border border-white/5 focus:border-blue-500 text-white shadow-inner" />
                      </div>
                      <div className="grid grid-cols-2 gap-3">
                          <div className="space-y-1">
                              ...
                              <input type="number" value={sysConfig.msgDelay} onChange={e => setSysConfig({...sysConfig, msgDelay: Number(e.target.value)})} className="w-full bg-black/40 p-3 rounded-lg text-xs font-black outline-none border border-white/5 focus:border-amber-500 text-white shadow-inner" />
                          </div>
                      ...
                      <button onClick={saveConfig} className="w-full bg-blue-600 hover:bg-blue-700 text-white font-black py-3 rounded-xl text-xs uppercase flex items-center justify-center gap-2 shadow-lg transition-all active:scale-95">
                          <Save size={14}/> שמור וסנכרן תשתית
                      </button>
                  </div>
                  ...
                  <div className="space-y-2">
                      <p className="text-[10px] font-black text-slate-500 uppercase px-2">מלשינון תעבורה (rami/incoming)</p>
